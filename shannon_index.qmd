...
This works becausem as we noted earlier, a community with $N$ evenly-represented species has a Shannon Index of $H = \ln(N)$. Hence,

$$
D = \exp(H) = \exp(\ln(N)) = N
$$

and in this special case, **effective number of species is the same as the actual number of species.**
:::
